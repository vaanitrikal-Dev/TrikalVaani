...
const SERVICE_SCHEMA = {
  ...
  url: 'https://trikalvaani.com/astrologer-noida',
  description:
    'Online Vedic astrology readings for clients in Noida and India — kundli, Kundali Milan, Mangal Dosh and Sade Sati analysis — computed on a self-hosted Swiss Ephemeris engine using Brihat Parashara Hora Shastra classical rules, under Rohiit Gupta, Chief Vedic Architect.',
  provider: {
    '@type': 'Organization',
