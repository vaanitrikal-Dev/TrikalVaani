      ...
      <main className="min-h-screen pt-20 pb-16 px-4" style={{ background: '#080B12', color: '#E5E7EB' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mt-16 prose prose-invert max-w-none">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Trikaal Vaani ka engine yahan rukता nahi — woh ek <strong style={{ color: GOLD }}>Gemologist Brain</strong> chalata hai jo har graha ki <em>poori</em> bhaav-swamitva dekhta hai. Sabse mukhya niyam: ratna graha ke <strong>poore prabhav</strong> ko jagaता hai, isliye agar graha kisi <strong style={{ color: GOLD }}>dushthana</strong> ka swami hai toh uska ratna khatra ban jaata hai — aur yeh khatra barabar nahi hota: <strong>8th (randhresh) = Avoid</strong>, 12th = strong caution, 6th = halka. Saaf <strong style={{ color: GOLD }}>yogakaraka</strong> (kendra + trikona ka swami) ka ratna sabse uttam hota hai aur enemy-sign/bhaav ki kami ko bhi override kar deta hai.
            </p>
            <p className="text-slate-300 leading-relaxed mb-4">
              Iske saath engine <strong>Shadbala</strong> (asli bal), <strong>dignity</strong> (mitra/shatru rashi), <strong>bhaav</strong>, <strong>dasha</strong>, <strong>Marana Karaka Sthana</strong> (graha apne mrityu-bhaav mein), <strong>combustion</strong> (Surya ke paas "jala" graha), aur <strong>papakartari/badhaka</strong> jaise yog bhi joड़ता hai — kul milakar 0–100 score, risk aur saaf verdict. Doctrine seedhi hai: <strong style={{ color: GOLD }}>ratna ek balheen shubh graha ko mazboot karta hai</strong>; functional malefic ya afflicted graha ka ratna ulta nuksaan kar sakta hai. Har suitable ratna ke saath uska <strong>upratna</strong> (sasta vikalp) bhi diya jaata hai.
            </p>
          </section>
