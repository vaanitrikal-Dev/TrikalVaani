    ...
    <>
      ...
      <Script id="kundali-calc-software-schema" type="application/ld+json" strategy="beforeInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          name: 'Trikaal Vaani Free AI Kundli Calculator', applicationCategory: 'LifestyleApplication', operatingSystem: 'Web',
      ...
      <Script id="kundali-calc-howto-schema" type="application/ld+json" strategy="beforeInteractive"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          description: 'Trikaal Vaani ke free AI Kundli Calculator se apni Janm Kundali kaise banayein — step by step.',
      ...
      <main className="min-h-screen pt-20 pb-16 px-4" style={{ background: '#080B12', color: '#E5E7EB' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mt-16 prose prose-invert max-w-none">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Maharishi Parashar ne <em>Brihat Parashara Hora Shastra (BPHS)</em> mein likha hai ki kundli ke 12 bhava (houses) aapke jeevan ke 12 alag-alag kshetra dikhate hain. Pehla bhav (Lagna) aapka vyaktitva dikhata hai, doosra dhan, saatva vivah, dasvan karma.
            </p>
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              <strong style={{ color: GOLD }}>Chandra Rashi (Moon Sign):</strong> Janm samay Chandra jis rashi mein the — yeh aapka mann, emotions dikhata hai. Indian astrology mein predictions zyadatar Chandra Rashi pe based hoti hain.
            </p>
            <p className="text-slate-300 leading-relaxed mb-4">
              <strong style={{ color: GOLD }}>Nakshatra:</strong> 27 nakshatron mein se ek — jis nakshatra mein Chandra ho. Yeh aapka karma pattern aur emotional makeup decide karta hai.
            </p>
          </section>
