// ============================================================
// File: app/calculators/free-should-i-wear-panna/layout.tsx
...
//   "Should I Wear Panna? 60-Sec Kundli Jaanch | Trikaal Vaani"
...
//
// TARGET KEYWORD  : should i wear panna
// AUDIENCE CONCERN: Someone advised Panna and they are not sure it is safe for their chart
// PAGE OFFER      : Budh ka bal, ast sthiti aur bhaav-swamitva lagna ke against jaanche jaate hain
//
...
export const metadata: Metadata = {
  title: { absolute: 'Should I Wear Panna? 60-Sec Kundli Jaanch | Trikaal Vaani' },
  description:
    'Panna (Emerald) aapke lagna ke anukool hai ya nahi — Budh ka bal aur ast sthiti dekhkar. Free jaanch, bina signup. Kharidne se pehle check karein.',
  keywords: [
    'should i wear panna',
    'panna pehnein ya nahi',
    'panna kis rashi ko pehnna chahiye',
    'panna benefits astrology',
    'panna suitability calculator',
    'panna kundli check',
  ],
  alternates: { canonical: 'https://trikalvaani.com/calculators/free-should-i-wear-panna' },
  openGraph: {
    title: 'Should I Wear Panna? 60-Sec Kundli Jaanch | Trikaal Vaani',
    description: 'Panna (Emerald) aapke lagna ke anukool hai ya nahi — Budh ka bal aur ast sthiti dekhkar. Free jaanch, bina signup. Kharidne se pehle check karein.',
    url: 'https://trikalvaani.com/calculators/free-should-i-wear-panna',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Should I Wear Panna? 60-Sec Kundli Jaanch | Trikaal Vaani',
    description: 'Panna (Emerald) aapke lagna ke anukool hai ya nahi — Budh ka bal aur ast sthiti dekhkar. Free jaanch, bina.',
  },
  robots: { index: true, follow: true },
};

export default function ShouldIWearPannaLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
