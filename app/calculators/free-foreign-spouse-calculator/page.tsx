...
const SECTIONS: FsSection[] = [
  {
    ...
    paras: [
      ...
      'Ek baat jo score padhne se pehle jaan lena zaroori hai: **ye chhe blocks barabar weight nahi rakhte.** Rahu ka 7th se seedha sambandh aur Navamsa ki pushti sabse bhaari hain; Shukra ka sanket sabse halka. Isliye do log jinka total score lagbhag ek jaisa ho, unki wajah bilkul alag ho sakti hai — aur breakdown wahi dikhata hai. Sirf number dekh kar nikal jaana is page ka sabse kam upyogi tareeka hai.',
      'Aur ek seema jo har jyotishiya tool par lagu hoti hai: **ye yog ki prabalta naapta hai, ghatna ki nishchitta nahi.** Prabal yog wale bahut se logon ki shaadi apne hi samaj mein hoti hai, aur kamzor yog wale bahut se log videsh mein bas jaate hain. Kundali pravritti batati hai; faisle aap lete hain, paristhitiyan bhi apna hissa dalti hain.',
    ],
  },
  {
    id: 'what-indicates',
    ...
    paras: [
      ...
      'One correction worth making, because it is where the money goes. **A single indicator is not a yog.** The classical requirement is convergence — two or three independent indicators agreeing, and the Navamsa confirming rather than contradicting them. A chart with Rahu in the 7th and nothing else scores low here, and it should. A chart with the 7th lord in the 12th, Darakaraka in the 9th and the Navamsa placing the 7th lord in a movable sign scores high, and every reason is printed so you can check it against your own chart rather than take it on trust.',
  ...
  },
  {
    ...
    paras: [
      ...
      'Navamsa ke baare mein ek aam galatfehmi: log samajhte hain ki D-9 koi "alag kundali" hai. Aisa nahi hai — **Navamsa usi janm-kundali ka nauva vibhajan hai**, har rashi ko nau hisson mein baant kar banaya gaya. Wo Rasi se alag jaankari nahi deta, balki **usi jaankari ki gehrai** deta hai: Rasi kya vaada karti hai, aur Navamsa us vaade ko kitna sahara deti hai.',
      'Vyavhaar mein sabse kaam ki sthiti wo hoti hai jahan **dono aapas mein sahmat na hon** — Rasi mein prabal videshi yog, par Navamsa mein 7th ka swami sthir aur ghar par. Aise chart mein aksar rishta videshi shuru hota hai par nibhta sthaniya hi hai, ya videsh jaakar wapas lautna padta hai. Ye baarikee sirf D-9 dekhne se milti hai.',
