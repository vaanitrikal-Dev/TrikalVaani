...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Trikaal Vaani offers three language options - Hinglish (Hindi-English mix, default for couples), Pure Hindi (for parent/family version, Sanskrit shloka references included), and English. Choose during the form fill before payment.',
      },
    },
    {
      '@type': 'Question',
