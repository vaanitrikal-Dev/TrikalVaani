// 🔱 TRIKAL VAANI | app/kundali-milan/page.tsx | v1.0
// Owner: Rohiit Gupta, Chief Vedic Architect
// Date: 2026-05-19
// ============================================================================
// PURPOSE:
//   Kundali Milan pillar page — hosts the dual form and serves as primary SEO
//   target for the keyword cluster "kundali matching" (246K monthly searches).
//
// IRON RULES OBSERVED:
//   - IR-13: KundaliMilanForm v1.0 LOCKED
//   - IR-19: Pricing locked Free/₹51/₹101/₹151
//   - IR-22: PDF + WA/Email/Link sharing as first-class
//
// SEO/GEO ARCHITECTURE (CEO-locked v2.0 strategy):
//   1. GEO direct-answer block (60 words) — top of page for AI extraction
//   2. Form section (this is the conversion surface)
//   3. Educational content (36 Guna explained, doshas, what's included)
//   4. FAQPage schema — 10 Q&A pairs for AI search
//   5. CTA + author E-E-A-T (Rohiit Gupta credentials)
//
// METADATA:
//   - Title targets "kundali matching" + "kundali milan" + brand
//   - Description includes price hooks ₹51/₹101/₹151
//   - Canonical URL set
//   - Hindi + English alternates
// ============================================================================
...
export const metadata: Metadata = {
  ...
  description:
    'Free Kundali Milan with 36 Guna Ashtakoot, Mangal Dosh, Nadi Dosh check. ₹51 Basic Milan, ₹101 Deep Milan with Dos, Donts & 6 personalized remedies. By Rohiit Gupta, Chief Vedic Architect, Delhi NCR. Swiss Ephemeris + BPHS classical rules.',
  ...
  openGraph: {
    title: 'Kundali Milan — Free 36 Guna Matching & Vedic Compatibility | Trikal Vaani',
    description:
      'Free Kundali Milan with 36 Guna Ashtakoot, Mangal Dosh, Nadi Dosh check. Deep ₹101 readings with personalized remedies by Rohiit Gupta.',
  ...
  twitter: {
    ...
    description: 'Free Kundali Milan with 36 Guna, Mangal Dosh, Nadi Dosh. Deep ₹101 readings with remedies.',
...
// ─────────────────────────────────────────────────────────────
// FAQPage SCHEMA — 10 Q&A pairs for AI/GEO extraction
// ─────────────────────────────────────────────────────────────
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Enter both partners birth details (date, time, place). Trikal computes both kundalis using Swiss Ephemeris precision, then matches all 8 Ashtakoot koots, checks Mangal, Nadi, and Bhakoot Dosh, and generates a personalized report. Choose Couple, Parent, or Both narrative styles for ₹101-151.',
      },
    },
    {
      '@type': 'Question',
      name: 'What is the difference between Basic ₹51 and Deep ₹101 Milan?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Basic ₹51 Milan includes full 36 Guna breakdown, all dosha analysis, and compatibility verdict. Deep ₹101 Milan adds personalized Dos and Donts, 6 ritual remedies (mantra, daan, vrat, ratna, pooja, muhurat), Dashakoot analysis, Navamsa D9 chart comparison, and audience-specific narrative (Couple or Parent version).',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The ₹101 Deep Milan tier provides 6 personalized remedies based on detected doshas — specific mantras with count and timing, daan items and recipients, fast days (vrat), gemstones with metal and finger guidance, pujas with location, and exact auspicious muhurat windows for marriage, engagement, and griha pravesh.',
      },
    },
    {
      '@type': 'Question',
    ...
    <>
      ...
      <div className="min-h-screen bg-[#080B12]">
        ...
        <main>
          ...
          {/* ═══════════════════════════════════════════════════════════════
              SECTION 1 — GEO DIRECT ANSWER BLOCK (60 words)
              For AI search engines: Perplexity, SearchGPT, Gemini, Google SGE
              ═══════════════════════════════════════════════════════════════ */}
          <section className="pt-24 pb-8 px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p style={{
                ...
                Swiss Ephemeris precision and BPHS classical rules. Free preview, ₹51 deep analysis, ₹101 with personalized remedies.
              </p>
            </div>
          </section>

          {/* ═══════════════════════════════════════════════════════════════
              SECTION 2 — THE FORM (conversion surface)
              ═══════════════════════════════════════════════════════════════ */}
          <KundaliMilanForm />

          {/* ═══════════════════════════════════════════════════════════════
              SECTION 3 — EDUCATIONAL CONTENT (36 Guna explained)
              ═══════════════════════════════════════════════════════════════ */}
          ...
          {/* ═══════════════════════════════════════════════════════════════
              SECTION 4 — WHAT'S INCLUDED (tier feature comparison)
              ═══════════════════════════════════════════════════════════════ */}
...
// ============================================================================
// END app/kundali-milan/page.tsx v1.0
