...
const jsonLd = {
  ...
  "@graph": [
    ...
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://trikalvaani.com" }, { "@type": "ListItem", position: 2, name: "Services", item: "https://trikalvaani.com/services" }, { "@type": "ListItem", position: 3, name: "Kundali Matching — Deep Compatibility Reading", item: "https://trikalvaani.com/services/compatibility" }] },
  ],
};
...
const testimonials = [
  { name: "Deepak & Riya Malhotra", city: "Delhi", date: "December 2024", text: "Our families said 28/36 gunas — perfect match. But Rohiit ji's reading showed Nadi Dosha and conflicting Venus placements. We did remedies before marriage. Two years in, no conflicts.", stars: 5 },
  { name: "Pooja Gupta", city: "Jaipur", date: "October 2024", text: "I was rejected due to Mangal Dosha. Jini showed my Mangal is in Aries in the 7th — actually auspicious for a strong partner. I shared the report and they reconsidered.", stars: 5 },
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#080B12] text-white">
        <SiteNav />
        <HeroSection
          badge="Deep Compatibility Intelligence · by Rohiit Gupta"
          h1a="Are You" h1gold="Truly Compatible?" h1b="Beyond 36 Gunas."
          sub="Jini AI reads both charts — Navamsa, Mangal Dosha, Nadi Dosha, Dasha sync — to reveal the soul-level truth of your compatibility. Not just a number."
          segment="compatibility"
          waText="I%20want%20a%20kundali%20compatibility%20reading"
          cta="Get Compatibility Reading — ₹51"
          glow="bg-rose-900/15"
        />
        <AuthorStrip />
        <ReasonsSection reasons={reasons} title="Why Deep Vedic Compatibility" highlight="Goes Further" />
        <HowItWorksSection segment="compatibility" steps=[
        ...
        <CtaSection headline="Know the Truth Before You" highlight="Say Yes." body="Marriage is the most important karmic contract of your life. ₹51 to read both charts before you commit." segment="compatibility" waText="I%20want%20a%20kundali%20compatibility%20reading" />
        <SiteFooter />
      </main>
    </>
  );
