    ...
    <>
      ...
      <main className="min-h-screen bg-[#080B12] text-white">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                {[
                  ...
                  { step: "02", title: "Trikaal AI Reads Both Charts", desc: "Full Ashtakoot + Navamsa D9 + Mangal/Nadi Dosha check + Dasha synchronicity across both charts." },
                  ...
                  { step: "04", title: "Go Deeper — Karmic Background Reading", desc: "₹251 Karmic Background Reading (Bhrigu Nadi) reveals the karmic root behind the bond — the deeper why behind how two charts meet, with Vedic remedies." },
                ].map((s, i) => (
        ...
        <TestimonialsSection label="What People Are" items={[
          ...
          { name: "Pooja Gupta", city: "Jaipur", date: "October 2024", text: "I was rejected by a family due to Mangal Dosha. Trikaal AI showed my Mangal is in Aries in the 7th — actually auspicious for a strong partner. I shared the report and they reconsidered." },
          { name: "Sanjay Arora", city: "Chandigarh", date: "February 2025", text: "The Dasha sync analysis was mind-blowing. Trikaal AI showed both our Jupiter Dashas run parallel for the next 7 years. That gave us confidence to commit." },
        ]} />
        <MaaDivineSeva />
        <FaqSection items={[
    ...
    <div className="border border-[#D4AF37]/30 rounded-2xl p-8 bg-gradient-to-br from-[#D4AF37]/10 to-[#7C3AED]/10">
      ...
      <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-xs">Deep compatibility reading</p>
        </div>
