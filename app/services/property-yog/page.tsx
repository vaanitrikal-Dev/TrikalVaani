...
export const metadata: Metadata = {
  ...
  description: "Chief Vedic Architect Rohiit Gupta reads your 4th House, Mars & Saturn to reveal if Property Yog is active — or if buying now is a costly karmic mistake. ₹51 reading. 15+ years of Vedic astrology expertise.",
...
const schema = {
  ...
  "@graph": [
    { "@type": "Service", name: "Property Yog — Real Estate Timing Reading", provider: { "@type": "Person", name: "Rohiit Gupta", jobTitle: "Chief Vedic Architect", url: "https://trikalvaani.com/about" }, offers: [{ "@type": "Offer", price: "51", priceCurrency: "INR" }], areaServed: "IN" },
    ...
    <>
      ...
      <main className="min-h-screen bg-[#080B12] text-white">
        ...
        <section className="relative overflow-hidden pt-28 pb-20 px-4">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 border border-[#D4AF37]/40 rounded-full px-4 py-1.5 mb-8 bg-[#D4AF37]/5">
              ...
              <span className="text-[#D4AF37] text-sm font-medium tracking-widest uppercase">Property Karma Intelligence · by Rohiit Gupta</span>
            </div>
            ...
            <p className="text-sm text-gray-500 mb-10">Reading designed by <Link href="/about" className="text-[#D4AF37] hover:underline">Rohiit Gupta</Link> — Chief Vedic Architect · 15+ years Vedic astrology · Swiss Ephemeris (self-hosted on Render)</p>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                {[
                  ...
                  { step: "02", title: "Trikaal AI Reads Your Property Yog", desc: "4th lord strength, Mars placement, Saturn transit over 4th house, and Dasha activation of real-estate yogas in your chart." },
                  ...
                  { step: "04", title: "Go Deeper — Karmic Background Reading", desc: "₹251 Karmic Background Reading (Bhrigu Nadi) reveals the karmic root behind your property and wealth patterns — the deeper why behind the timing." },
                ].map((s, i) => (
        ...
        <TestimonialsSection label="What People Are" items={[
          { name: "Amit Saxena", city: "Delhi NCR", date: "September 2024", text: "I was about to book a flat in Noida Extension. Rohiit ji's reading showed my 4th lord was combust and Mars was in the 12th — loss house. He said wait 8 months. The builder project got stalled. I saved Rs 45 lakh." },
          { name: "Sunita Kapoor", city: "Faridabad", date: "January 2025", text: "My chart showed a strong Property Yog — Jupiter aspecting the 4th house and Mars in exaltation. Trikaal AI confirmed: buy now. The flat I bought has already appreciated 18%." },
          { name: "Rajesh Tiwari", city: "Lucknow", date: "March 2025", text: "My wife and I had fights about buying ancestral land. Trikaal AI showed my 4th house had a pending karmic settlement. We waited and the price dropped significantly." },
        ]} />
        <MaaDivineSeva />
        <FaqSection items={[
        ...
        <CtaSection headline="Before You Sign Anything —" highlight="Read Your Stars." body="A property is a multi-lakh decision. Rs 51 to verify if the timing is right — or if your chart is warning you to wait." segment="property-yog" waText="I%20need%20a%20property%20yog%20reading" />
        <SiteFooter />
      </main>
    </>
  );
    ...
    <div className="border border-[#D4AF37]/30 rounded-2xl p-8 bg-gradient-to-br from-[#D4AF37]/10 to-[#7C3AED]/10">
      ...
      <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-xs">Deep property reading</p>
        </div>
