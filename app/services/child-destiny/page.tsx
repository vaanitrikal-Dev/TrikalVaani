    ...
    <>
      ...
      <main className="min-h-screen bg-[#080B12] text-white">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                {[
                  ...
                  { step: "02", title: "Trikaal AI Maps Their Cosmic Blueprint", desc: "5th house lord analysis, Moon nakshatra learning style, Mercury and Jupiter education domain, Dasha timeline for peak talent years." },
                  ...
                  { step: "04", title: "Go Deeper — Karmic Background Reading", desc: "₹251 Karmic Background Reading (Bhrigu Nadi) reveals the karmic root behind your child\u2019s patterns — the deeper why behind their gifts and challenges." },
                ].map((s, i) => (
        ...
        <TestimonialsSection label="What Parents Are" items={[
          { name: "Anita Sharma", city: "Gurgaon", date: "November 2024", text: "My son was forced into science stream. Trikaal AI's reading showed his Mercury in 12th house with strong Venus — a creative communicator, not an engineer. He's now thriving in journalism." },
    ...
    <div className="border border-[#D4AF37]/30 rounded-2xl p-8 bg-gradient-to-br from-[#D4AF37]/10 to-[#7C3AED]/10">
      ...
      <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-xs">Deep child reading</p>
        </div>
