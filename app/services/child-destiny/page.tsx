...
const reasons = [
  ...
  { icon: "🌙", title: "Moon Sign Reveals Emotional Intelligence & Learning Style", desc: "The Moon sign and nakshatra determine how a child processes information, relates to teachers, and handles pressure. Understanding this transforms parenting and education choices." },
...
const testimonials = [
  ...
  { name: "Prashant Nanda", city: "Bhubaneswar", date: "January 2025", text: "We were pushing our daughter toward medicine. Her chart showed Jupiter in 5th in Sagittarius — a natural teacher. She's pursuing philosophy at DU and has never been happier.", stars: 5 },
...
const faqs = [
  ...
  { q: "At what age should I get my child's kundali read?", a: "The earlier the better. Readings are most actionable around ages 5–12 when education decisions begin, and at 15–16 for stream selection. The birth chart does not change, so a reading is relevant at any age." },
];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#080B12] text-white">
        <SiteNav />
        <HeroSection
          badge="Child Destiny Intelligence · by Rohiit Gupta"
          h1a="What Is Your Child" h1gold="Born to Become?" h1b="Their Stars Know."
          sub="Jini AI reads your child's 5th House, Moon sign, Mercury & Lagna to reveal hidden talents, ideal education stream, and cosmic calling — before society tells them who to be."
          segment="child-destiny"
          waText="I%20want%20a%20child%20destiny%20astrology%20reading"
          cta="Get Child's Destiny Reading — ₹51"
          glow="bg-blue-900/15"
        />
        <AuthorStrip />
        <ReasonsSection reasons={reasons} title="Why Vedic Astrology Reveals" highlight="Your Child's Gift" />
        <HowItWorksSection segment="child-destiny" steps=[
        ...
        <CtaSection headline="Give Your Child the Gift of" highlight="Cosmic Clarity." body="Every child is born with a unique cosmic blueprint. ₹51 to read it — before the education system overwrites it." segment="child-destiny" waText="I%20want%20a%20child%20destiny%20astrology%20reading" />
        <SiteFooter />
      </main>
    </>
  );
