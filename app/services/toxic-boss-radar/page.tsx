    ...
    <>
      ...
      <main className="min-h-screen bg-[#080B12] text-white">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                {[
                  ...
                  { step: "02", title: "Trikaal AI Scans Your Work Karma", desc: "10th lord placement, Saturn transit, 6th house enemies, and Rahu/Ketu impact on career authority dynamics." },
                  ...
                  { step: "04", title: "Go Deeper — Karmic Background Reading", desc: "₹251 Karmic Background Reading (Bhrigu Nadi) reveals the karmic root behind your workplace patterns — the deeper why behind the conflicts you keep facing." },
                ].map((s, i) => (
        ...
        <TestimonialsSection label="What People Are" items={[
          { name: "Rahul Verma", city: "Noida", date: "October 2024", text: "I was gaslit by my manager for 2 years. Trikaal AI told me my Saturn return was triggering authority conflicts — and that October would bring a resolution. I got a new offer in October." },
    ...
    <div className="border border-[#D4AF37]/30 rounded-2xl p-8 bg-gradient-to-br from-[#D4AF37]/10 to-[#7C3AED]/10">
      ...
      <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-xs">Deep workplace reading</p>
        </div>
