...
const schema = {
  ...
  "@graph": [
    { "@type": "Service", name: "Spiritual Purpose — Soul Mission Reading", provider: { "@type": "Person", name: "Rohiit Gupta", jobTitle: "Chief Vedic Architect", url: "https://trikalvaani.com/about" }, offers: [{ "@type": "Offer", price: "51", priceCurrency: "INR" }], areaServed: "IN" },
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#080B12] text-white">
        ...
        <CtaSection headline="You Came Here for a" highlight="Reason." body="The fact that you are asking this question is itself a karmic signal. Rs 51 to read your soul's blueprint and finally understand why you are here." segment="spiritual-purpose" waText="I%20need%20a%20spiritual%20purpose%20reading" />
        <SiteFooter />
      </main>
    </>
  );
