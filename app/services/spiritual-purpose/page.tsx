...
const jsonLd = {
  ...
  "@graph": [
    ...
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://trikalvaani.com" }, { "@type": "ListItem", position: 2, name: "Services", item: "https://trikalvaani.com/services" }, { "@type": "ListItem", position: 3, name: "Spiritual Purpose — Soul Mission Reading", item: "https://trikalvaani.com/services/spiritual-purpose" }] },
  ],
};
...
export default function Page() {
  return (
    <>
      <Script id="spiritual-purpose-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <main className="min-h-screen bg-[#080B12] text-white">
        <SiteNav />
        <HeroSection
          badge="Soul Purpose Intelligence · by Rohiit Gupta"
          h1a="What Is Your" h1gold="Soul's Purpose" h1b="in This Lifetime?"
          sub="Jini AI reads your Ketu, Atmakaraka & 12th House to decode your past-life karma, present dharmic mission, and the soul lesson you were born to complete."
          segment="spiritual-purpose"
          waText="I%20want%20a%20spiritual%20purpose%20astrology%20reading"
          cta="Get My Soul Purpose Reading — ₹51"
          glow="bg-indigo-900/20"
        />
        <AuthorStrip />
        <ReasonsSection reasons={reasons} title="Why Vedic Astrology Reveals" highlight="Your Soul's Mission" />
        <HowItWorksSection segment="spiritual-purpose" steps=[
        ...
        <CtaSection headline="You Came Here for a" highlight="Reason." body="The fact that you're asking this question is itself a karmic signal. ₹51 to read your soul's blueprint and finally understand why you're here." segment="spiritual-purpose" waText="I%20want%20a%20spiritual%20purpose%20astrology%20reading" />
        <SiteFooter />
      </main>
    </>
  );
