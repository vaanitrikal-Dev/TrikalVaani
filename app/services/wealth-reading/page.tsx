...
export const metadata: Metadata = {
  ...
  description: "Chief Vedic Architect Rohiit Gupta reads your 2nd House, Jupiter & Dhana Yoga to reveal your wealth timeline, peak earning years, and investment sectors your chart favors. ₹51 deep reading.",
  keywords: ["dhana yoga kundali astrology", "when will I get rich astrology", "wealth astrology vedic India", "2nd house money astrology", "Lakshmi yoga astrology", "Rohiit Gupta wealth astrology Delhi"],
  authors: [{ name: "Rohiit Gupta", url: "https://trikalvaani.com/about" }],
  openGraph: { title: "Dhana Yoga — When Will I Get Rich? | Trikal Vaani — Rohiit Gupta", description: "Your 2nd House and Jupiter reveal your wealth timeline. Jini AI decodes your Dhana Yoga and peak earning years.", url: "https://trikalvaani.com/services/wealth-reading", siteName: "Trikal Vaani", type: "website", locale: "en_IN" },
...
const jsonLd = {
  ...
  "@graph": [
    { "@type": "Service", "@id": "https://trikalvaani.com/services/wealth-reading", name: "Dhana Yoga — Wealth & Prosperity Reading", description: "Vedic astrology reading by Rohiit Gupta identifying Dhana Yoga combinations, 2nd/11th house strength, Jupiter placement, and Dasha timing to reveal wealth potential and peak earning years.", provider: { "@type": "Person", name: "Rohiit Gupta", jobTitle: "Chief Vedic Architect", url: "https://trikalvaani.com/about", knowsAbout: ["Vedic Astrology", "Dhana Yoga", "2nd House Wealth", "Jupiter Finance", "Lakshmi Yoga"] }, offers: [{ "@type": "Offer", name: "AI Deep Reading", price: "51", priceCurrency: "INR" }, { "@type": "Offer", name: "Personal Call with Rohiit Gupta", price: "499", priceCurrency: "INR" }], areaServed: "IN" },
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://trikalvaani.com" }, { "@type": "ListItem", position: 2, name: "Services", item: "https://trikalvaani.com/services" }, { "@type": "ListItem", position: 3, name: "Dhana Yoga — Wealth & Prosperity Reading", item: "https://trikalvaani.com/services/wealth-reading" }] },
  ],
};

const reasons = [
  { icon: "💰", title: "The 2nd & 11th Houses Govern Wealth Accumulation", desc: "The 2nd house rules earned wealth and family assets. The 11th house governs gains, profits, and income streams. When these houses and their lords are strong and activated by the right Dasha — wealth flows. When afflicted, no amount of hard work compensates." },
  { icon: "♃", title: "Jupiter Is the Planet of Abundance", desc: "Jupiter (Guru) is the significator of wealth, expansion, and fortune in Vedic astrology. Its placement and transit through your 2nd and 11th houses creates the wealth windows that define financial breakthroughs — not market conditions." },
  { icon: "✨", title: "Dhana Yoga Combinations Predict Financial Destiny", desc: "Classical Vedic texts describe over 32 Dhana Yogas — specific planetary combinations indicating wealth. Lakshmi Yoga, Chandra-Mangala Yoga, and Gaja Kesari Yoga each carry different wealth signatures. Identifying yours reveals the source and timing of your fortune." },
];
const testimonials = [
  { name: "Gaurav Taneja", city: "Noida", date: "January 2025", text: "My reading showed Dhana Yoga in the 2nd house with Jupiter aspecting it. Rohiit ji said my peak earning window was 2024–2027. I started a business in 2024. Revenue crossed ₹1 Cr in year one.", stars: 5 },
  { name: "Nirmala Devi", city: "Varanasi", date: "October 2024", text: "I was doing everything right but money wasn't accumulating. Jini showed Saturn in the 2nd house — delayed wealth, not denied. And that my 38th year would be my breakout. I'm 38 now.", stars: 5 },
  { name: "Harish Menon", city: "Bangalore", date: "February 2025", text: "The reading identified I have a Lakshmi Yoga suppressed by Rahu. Rohiit ji gave me specific remedies. Six months later, my startup got its first significant investor.", stars: 5 },
];
const faqs = [
...
export default function Page() {
  return (
    <>
      <Script id="wealth-reading-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <main className="min-h-screen bg-[#080B12] text-white">
        <SiteNav />
        <HeroSection
          badge="Wealth Karma Intelligence · by Rohiit Gupta"
          h1a="When Will You" h1gold="Get Rich?" h1b="Your Dhana Yoga Knows."
          sub="Jini AI reads your 2nd House, Jupiter & Dhana Yoga combinations to reveal your wealth timeline, peak earning years, and which sectors your chart cosmically favors."
          segment="wealth"
          waText="I%20want%20a%20wealth%20astrology%20reading"
          cta="Check My Dhana Yoga — ₹51"
          glow="bg-[#D4AF37]/15"
        />
        <AuthorStrip />
        <ReasonsSection reasons={reasons} title="Why Vedic Astrology Predicts" highlight="Your Wealth Timeline" />
        <HowItWorksSection segment="wealth" steps=[
          ...
          { step: "02", title: "Jini Scans Your Dhana Yogas", desc: "2nd/11th house lords, Jupiter placement, Lakshmi Yoga check, Chandra-Mangala Yoga, and Dasha activation analysis." },
          ...
          { step: "04", title: "Investment Strategy Call", desc: "₹499 personal call with Rohiit ji — combining Vedic wealth astrology with real estate and investment expertise." },
        ] deliverables=["Dhana Yoga identification & strength", "2nd & 11th house wealth analysis", "Peak earning years (Dasha-based)", "Investment sectors your chart favors", "Wealth blocks & remedies", "Lakshmi/Gaja Kesari Yoga check", "4-week financial energy forecast"] />
        <TestimonialsSection testimonials={testimonials} label="What People Are" />
        <MaaDivineSeva />
        <FaqSection faqs={faqs} />
        <CtaSection headline="Your Wealth Timeline Is Already" highlight="Written." body="Stop working harder. Start working in alignment. ₹51 to know your Dhana Yoga and peak earning window." segment="wealth" waText="I%20want%20a%20wealth%20astrology%20reading" />
        <SiteFooter />
      </main>
    </>
  );
