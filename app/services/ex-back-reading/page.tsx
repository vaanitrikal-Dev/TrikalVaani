 ...
 * Version: 3.0 — No external shared imports, fully self-contained
 */
...
export const metadata: Metadata = {
  ...
  description: "Chief Vedic Architect Rohiit Gupta reads your Venus, 7th House & Vimshottari Dasha to reveal if reunion energy is active — and exactly when the window opens. ₹51 deep reading. Swiss Ephemeris precision.",
  keywords: ["will my ex come back astrology", "ex back vedic astrology reading", "reunion prediction vedic astrology", "7th house astrology ex partner", "Venus dasha love astrology India", "Rohiit Gupta vedic astrologer Delhi"],
  authors: [{ name: "Rohiit Gupta", url: "https://trikalvaani.com/about" }],
  openGraph: { title: "Will My Ex Come Back? | Trikal Vaani — Rohiit Gupta", description: "Your birth chart holds the answer. Rohiit Gupta decodes your Venus, Dasha & 7th House for a reunion prediction.", url: "https://trikalvaani.com/services/ex-back-reading", siteName: "Trikal Vaani", type: "website", locale: "en_IN" },
...
const jsonLd = {
  ...
  "@graph": [
    { "@type": "Service", "@id": "https://trikalvaani.com/services/ex-back-reading", name: "Ex-Back Vedic Astrology Reading", description: "Vedic astrology reading by Rohiit Gupta analyzing Venus, 7th House, Navamsa D9, and Vimshottari Dasha to predict reunion potential and timing.", provider: { "@type": "Person", name: "Rohiit Gupta", jobTitle: "Chief Vedic Architect", url: "https://trikalvaani.com/about", knowsAbout: ["Vedic Astrology", "Vimshottari Dasha", "Navamsa Chart", "Venus Placement"] }, offers: [{ "@type": "Offer", name: "AI Deep Reading", price: "51", priceCurrency: "INR" }, { "@type": "Offer", name: "Personal Call with Rohiit Gupta", price: "499", priceCurrency: "INR" }], areaServed: "IN" },
    { "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "Can Vedic astrology predict if my ex will come back?", acceptedAnswer: { "@type": "Answer", text: "Yes. The 7th house governs partnerships and reconciliation. Venus rules love and reunion energy. Vimshottari Dasha timing pinpoints when reconciliation windows open or close. Rohiit Gupta analyzes all three together to give a probability and timing." } },
      ...
      { "@type": "Question", name: "What is Navamsa D9 and why does it matter for love predictions?", acceptedAnswer: { "@type": "Answer", text: "The Navamsa (D9) chart is the soul chart in Vedic astrology. It reveals whether a connection carries past-life karma and whether reconciliation is truly supported at the soul level." } },
    ]},
...
const reasons = [
  { icon: "♀", title: "Venus & Your 7th House Tell the Truth", desc: "Venus (Shukra) governs love and reunion. The 7th house is the house of partnership. Their position at your birth moment — and their current transits — reveal whether reconciliation energy is active in your chart right now." },
...
const faqs = [
  { q: "Can Vedic astrology predict if my ex will come back?", a: "Yes. The 7th house governs partnerships and reconciliation. Venus rules love and reunion energy. Vimshottari Dasha timing pinpoints when reconciliation windows open or close. Rohiit Gupta analyzes all three together." },
  ...
  { q: "Difference between ₹51 AI reading and ₹499 personal call?", a: "The ₹51 Jini AI reading gives a 4096-token deep analysis with a reunion window prediction. The ₹499 call connects you directly with Rohiit Gupta — ideal for complex cases involving marriage, children, or blocked communication." },
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#080B12] text-white">
        <SiteNav />
        <HeroSection
          badge="Vedic Love Intelligence · by Rohiit Gupta"
          h1a="Will Your Ex" h1gold="Come Back?" h1b="Your Stars Know the Answer."
          sub="Jini AI reads your Venus, 7th House & Vimshottari Dasha to reveal if reunion energy is active — and exactly when the window opens."
          segment="ex-back"
          waText="I%20want%20an%20ex-back%20astrology%20reading"
          cta="Get My Ex-Back Reading — ₹51"
          glow="bg-[#7C3AED]/20"
        />
        <AuthorStrip />
        <ReasonsSection reasons={reasons} title="Why Vedic Astrology Can Answer" highlight="This Question" />
        <HowItWorksSection
          segment="ex-back"
          steps={[
          ...
          deliverables={["Venus & 7th House analysis", "Navamsa D9 compatibility check", "Current Mahadasha love forecast", "Reunion window (if any) — exact months", "Karma lesson behind the separation", "What to do vs. what NOT to do", "4-week emotional energy forecast"]}
        />
        <TestimonialsSection testimonials={testimonials} label="What People Are" />
        <MaaDivineSeva />
        <FaqSection faqs={faqs} />
        <CtaSection headline="The Answer Is Already" highlight="Written in Your Stars" body="Stop wondering. Stop checking their Instagram. Your birth chart has the truth. ₹51 — less than a coffee." segment="ex-back" waText="I%20need%20an%20ex-back%20reading" />
        <SiteFooter />
      </main>
    </>
  );
