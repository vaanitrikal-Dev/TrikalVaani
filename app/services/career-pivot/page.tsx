      ...
      <main className="min-h-screen bg-[#080B12] text-white">
        ...
        <section className="relative overflow-hidden pt-28 pb-20 px-4">
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-3 leading-relaxed">Trikaal AI reads your 10th House, Jupiter, Atmakaraka & Dasha timing to reveal your dharmic profession — and the <span className="text-[#D4AF37] font-semibold">exact window</span> to pivot without financial risk.</p>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                {[
                  { step: "01", title: "Enter Your Birth Details", desc: "Date, time, place. We use Swiss Ephemeris (self-hosted on Render) with Lahiri Ayanamsha for maximum accuracy." },
                  { step: "02", title: "Trikaal AI Maps Your Career Karma", desc: "10th lord placement, Jupiter sign, Atmakaraka, D10 Dasamsa career chart — all analyzed for dharmic alignment." },
                  ...
                  { step: "04", title: "Go Deeper — Karmic Background Reading", desc: "₹251 Karmic Background Reading (Bhrigu Nadi) reveals the karmic root behind your career patterns — the deeper why behind the timing." },
                ].map((s, i) => (
        ...
        <TestimonialsSection label="What People Are" items={[
          { name: "Neha Agarwal", city: "Pune", date: "January 2025", text: "I was an engineer for 8 years and always felt wrong. Trikaal AI told me my Jupiter Mahadasha was the pivot window. I started my design studio. Best decision of my life." },
    ...
    <div className="border border-[#D4AF37]/30 rounded-2xl p-8 bg-gradient-to-br from-[#D4AF37]/10 to-[#7C3AED]/10">
      ...
      <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-xs">Deep career reading</p>
        </div>
