...
import DownloadPDF from '@/components/result/DownloadPDF'; // ✅ PDF Download
      ...
      {lagna && planets.length > 0 && (
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: -8 }}>
          <DownloadPDF
            ...
            mahadasha={mahadasha}
            antardasha={antardasha}
            pratayantarLord={pratayantarLord || undefined}
            dashaBalance={dashaBalance}
            planets={planets}
            lang={lang}
            isPremium={isPredictionPaid}
          />
        </div>
      )}
