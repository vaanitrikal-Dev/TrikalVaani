 ...
 * Version: 2.1 — Brand → Trikaal Vaani; Jini → Trikaal AI; §2 services aligned to
 *                real one-time ladder (removed phantom ₹99 + ₹499 consult)
 */
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10 text-gray-400 text-sm leading-relaxed">
            ...
            <div>
              ...
              <p className="mb-3">Trikaal Vaani provides AI-powered Vedic astrology readings including:</p>
              <ul className="space-y-2">
                {[
                  "Free Kundali and Panchang generation",
                  "Trikaal AI deep predictions (from ₹51) — powered by Gemini AI and Swiss Ephemeris",
                  "Kundali Milan compatibility readings (₹51 / ₹101 / ₹151)",
                  "Karmic Background Reading — Bhrigu Nandi Nadi analysis (₹251)",
                  "Child Birth Muhurat reports (₹101 / ₹151)",
