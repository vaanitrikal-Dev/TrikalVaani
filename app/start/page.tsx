// TRIKAL VAANI | app/start/page.tsx | v1.0
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://trikalvaani.com/start' },
  ...
  openGraph: {
    ...
    url: 'https://trikalvaani.com/start',
    type: 'website',
...
//     https://trikalvaani.com/start?utm_source=instagram&utm_medium=bio
//     https://trikalvaani.com/start?utm_source=facebook&utm_medium=bio
//   For a power-reel linking DIRECTLY to an engine, skip /start and use e.g.:
