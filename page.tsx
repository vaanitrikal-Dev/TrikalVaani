 ...
 *   ✅ Canonical URL pointing to /trikaal-vaani (owns its slug)
 ...
 *   Week 1-2: Google indexes the page
 *   Week 3-4: Page ranks for "trikaal vaani" branded searches
 *   Week 4-6: Gemini/Perplexity start citing for spelling questions
 *   Week 6-8: Outranks competitor for branded misspelling traffic
 * ============================================================================
 */
...
const breadcrumbSchema = {
  ...
  '@type': 'BreadcrumbList',
  '@id': 'https://trikalvaani.com/trikaal-vaani#breadcrumb',
  itemListElement: [
    {
      '@type': 'ListItem',
      position: 1,
